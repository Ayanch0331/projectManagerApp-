...
export class CommonService {
  ...
  postHttpCall(senddata: any, smallloader= false) {
    ...
    return this.http
      .post('/projectapp/' + senddata.url, senddata.data, {headers: this.headers})
      .toPromise()
      .then(res => {
         $('.total_loader').hide();
        return res;
  ...
  putHttpCall(senddata: any, smallloader= false) {
    ...
    console.log(senddata.data);
    return this.http
      .put('/projectapp/' + senddata.url, senddata.data, {headers: this.headers})
      .toPromise()
      .then(res => {
        $('.total_loader').hide();
        return res;
  ...
  deleteHttpCall(senddata: any) {
    ...
    return this.http
    .delete('/projectapp/user/' + senddata.url)
    .toPromise()
    .then(res => {
      $('.total_loader').hide();
      return res;
  ...
  getObservable(senddata: any): Observable<any> {
    return this.http.get<any>('/projectapp/' + senddata.url);
  }
